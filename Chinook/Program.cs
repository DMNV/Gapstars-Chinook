...
builder.Services.AddTransient<IArtistsRepo, ArtistsRepo>();
builder.Services.AddTransient<IPlaylistsRepo, PlaylistsRepo>();
builder.Services.AddTransient<ITracksRepo, TracksRepo>();
